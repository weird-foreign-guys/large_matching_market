...
def deferred_acceptance(male_prefs, female_prefs):
    ...
    while True:
        ...
        for male in unmatched_males:
            ...
            prev_male_index = female_prefs[female].index(prev_male) if prev_male else None
            this_male_index = female_prefs[female].index(male) if male in female_prefs[female] else None
