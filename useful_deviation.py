...
def deviation_count_mockup(proposer_prefs, proposed_prefs):
        truthful_match = deferred_acceptance(proposer_prefs,proposed_prefs)
        ...
        while females_left != []: 
                ...
                while proposed_prefs_d[female] != []:
                        ...
                        matching_d = deferred_acceptance(proposer_prefs,proposed_prefs_d)
...
def useful_deviation(truthful_match, result_match, deviator, proposed_prefs):
        ...
        return (preference_order.index(truthful_match[deviator]) > preference_order.index(result_match[deviator]))
